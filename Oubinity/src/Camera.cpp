...
Camera::Camera(glm::vec3 position)
    : m_camera_pos(position),
      ...
      m_yaw(-90.0f),
      m_pitch(0.0f),
      m_speed(Settings::SETTING_CAMERA_SPEED),
...
glm::mat4 Camera::getProjectionMatrix() {
  return glm::perspective(glm::radians(m_fov),
                          Window::SCREEN_WIDTH / Window::SCREEN_HEIGHT, 0.1f,
                          20000.0f);
}
...
glm::vec3 Camera::getCameraPos() { return m_camera_pos; }

glm::vec3 Camera::getCameraRight() { return m_camera_right; }

glm::vec3 Camera::getCameraUp() { return m_camera_up; }

float Camera::getPitch() { return m_pitch; }

float Camera::getYaw() { return m_yaw; }

glm::vec3 Camera::getCameraFront() { return m_camera_front; }
